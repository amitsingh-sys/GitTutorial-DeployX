...
""
"1. Creates a dictionary with 'id' and 'review' keys and converts it to a pandas DataFrame."
"2. Saves the DataFrame to a CSV file named 'data.csv' in a folder"
"   named 'data'. If the folder does not exist, it creates it."
"3. Loads the 'data.csv' file, applies CountVectorizer to the 'review"
"   column to create K new columns based on the most frequent words, and"
"   saves the processed DataFrame to 'processed_data.csv' in the same folder."
"4. Finally, it prints the shapes of the original and processed DataFrames."
""
import os
import pandas as pd
